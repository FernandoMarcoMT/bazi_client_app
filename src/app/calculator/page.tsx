...
import BaziForm from "@/components/calculator/BaziForm";
import BaziResultChart from "@/components/calculator/BaziResultChart";
...
const CalculatorContent = () => {
  ...
  if (!context) {
    throw new Error("CalculatorContent must be wrapped in BaziCalculatorProvider");
  }
  ...
  return (
    <>
      ...
      {step === 1 && results && <BaziResultChart lunar={results}  gender={context.gender} />}
