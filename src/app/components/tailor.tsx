...
export default function Tailor() {
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center lg:gap-10 xl:gap-40 xl:pl-10">
      <div className="flex flex-col gap-3 w-full max-w-[690px] mt-4 lg:mt-0">
        ...
        <div className="flex flex-col gap-6">
          <p className="text-lg font-light lg:font-normal leading-[1.5em] max-w-[93%]">
        ...
        <ButtonShaped text="Explore Services" variant="light" buttonClassName="mt-6 lg:-0 mx-auto lg:mx-0" />
      </div>

      <div className="relative h-[340px] lg:h-[440px] xl:h-[640px] w-[340px] lg:w-full max-w-[660px]">
        <Image
