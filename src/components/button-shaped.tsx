...
export default function ButtonShaped({ text, customClass }: ButtonShapedProps) {
  const { theme, themes, systemTheme } = useTheme();

  console.log(systemTheme);

  return (
    <button
      className={cn("relative flex items-center justify-center cursor-pointer", customClass)}
    >
      <svg
      ...
      >
        <path
          ...
          stroke={
            theme === "light" || systemTheme === "light" ? "#FFC447" : "#647CA3"
          }
          strokeMiterlimit="10"
        />
      </svg>
