...
const BaziForm = (props: BaziFormProps) => {
  ...
  if (!context) {
    throw new Error("Check if the component is wrapped around BaziCalculatorContextProvider");
  }
  const {
    fullname,
    gender,
  ...
  return (
    <div className="relative">
      <NavBar />
      <div className="w-full flex flex-col gap-8 min-h-screen items-center justify-center bg-white md:bg-[url('/images/background.jpg')] md:bg-gray-700 md:bg-blend-multiply bg-cover">
        <div>
