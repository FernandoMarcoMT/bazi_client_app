  ...
  return (
    <section className="flex flex-col gap-[30px]">
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4 xl:gap-8 h-full md:min-h-[400px] 2xl:min-h-[500px]">
        <div className="flex flex-col justify-center gap-6 p-8 md:p-10 lg:p-12 2xl:p-15 relative border-[3px] border-collapse border-secondary">
          <img
        ...
        <div className="flex flex-col justify-center gap-6 p-8 md:p-10 lg:p-12 2xl:p-15 relative border-[3px] border-collapse border-secondary">
          ...
          <img
            src="/images/Hidden Core Personality/Zodiac/rat.png"
            alt="Zodiac"
            className="w-full max-w-[120px] md:max-w-[180px] xl:max-w-[220px] object-cover object-center mx-auto"
          />
          <div className="flex flex-col gap-2 md:gap-3">
            ...
            <p className="font-light md:font-normal text-sm md:text-base 2xl:text-xl">
              Clever yet grounded. Strategic and calm, they move with quiet
              purpose, blending instinct with steady ambition.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center gap-6 p-8 md:p-10 lg:p-12 2xl:p-15 relative border-[3px] border-collapse border-secondary">
          ...
          <img
            src="/images/Hidden Core Personality/God/eating-god.png"
            alt="God"
            className="w-full max-w-[120px] md:max-w-[180px] xl:max-w-[220px] object-cover object-center mx-auto"
          />
          <div className="flex flex-col gap-2 md:gap-3">
            ...
            <p className="font-light md:font-normal text-sm md:text-base 2xl:text-xl">
              The child of your essence, a muse born of soul and spirit. It
              weaves beauty from breath, nurturing the world with quiet magic
