  ...
  return (
    <div className="flex flex-col relative gap-4 xl:gap-6">
      <div className="flex flex-col gap-2 w-full z-[1]">
        <p className="uppercase font-bold font-oswald text-white text-3xl lg:text-[44px] 2xl:text-[120px] leading-none">
          Analytical Depth
        </p>
        <p className="uppercase font-bold font-oswald text-white text-3xl lg:text-[44px] 2xl:text-[120px] leading-none xl:ml-auto">
          Decision Paralysis
        </p>
      </div>
      ...
      <div className="flex xl:hidden flex-col gap-2">
        <p className="text-white font-bold font-oswald text-xl lg:text-[32px] uppercase">
          Inherit Strength
        </p>

        <p className="text-white font-light text-sm lg:text-base leading-[1.6em]">
          Picture a mountain that has weathered countless storms yet remains
          unmoved, Wu Zi individuals stand firmly on their principles. Their
          ethical foundation isn't easily shaken by changing circumstances or
          social pressure.
