...
export default function TenGodZodiac({ element }: { element: string }) {
  ...
  return (
    ...
    >
      <div className="chara-title hidden md:flex absolute top-28 z-[2]">
        <p className="chara-hanzi-t font-zhi-mang-xing text-[110px] md:text-[160px] 2xl:text-[240px] leading-[1em]">
          戊
        </p>
      ...
      <div className="chara-title flex md:hidden px-4 z-[2]">
        <p className="chara-hanzi-t font-zhi-mang-xing text-[110px] md:text-[160px] 2xl:text-[240px] leading-[1em]">
          戊
        </p>
      ...
      <img
        src={`/images/Master Element/${element}.png`}
        alt="Ten Day Master"
        className="character object-cover object-center md:object-[-240px_0] xl:object-[100px_0] 2xl:object-[150px_0] min-h-[490px] md:min-h-[750px] lg:min-h-[850px] mt-[-32px] md:mt-0 z-[1]"
      />

      <div className="chara-desc flex flex-col gap-2 md:absolute bottom-10 left-[24px] xl:left-0 xl:right-0 2xl:right-20 md:ml-auto max-w-[450px] md:opacity-0 px-6 md:px-0 z-[2]">
        <p className="font-bold font-oswald text-[20px] md:text-3xl uppercase">
          Wu Earth
        </p>

        <div className="flex flex-col gap-4">
          <p className="font-light text-sm md:text-base leading-[1.6em] md:leading-normal">
